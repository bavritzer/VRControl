...
class PotatoHTTPServer(CGIHTTPRequestHandler):
    ...
    def do_PUT(self):
        ...
        generator = torch.manual_seed(0)
        image_output = pipe("a painting in the style of Monet, Masterpiece", image, num_inference_steps=10, width=512, height=512, generator = generator, guidance_scale=6).images[0]
        image_output.save(fnameout, format='png')
